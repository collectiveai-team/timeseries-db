...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run tests for TimescaleDB CRUD system")
    parser.add_argument(
        "test_type",
    ...
    if args.test_type in ["integration", "all"]:
        ...
        env["TEST_DATABASE_URL"] = "postgresql://test_user:test_password@localhost:5432/tsdb"
